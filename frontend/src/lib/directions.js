...
export const DIRECTIONS = [
  ...
  },
  {
    ...
    desc: {
      ru: "МАК и ресурсные колоды: COPE, ценности, ресурсы, аффирмации.",
      uk: "МАК і ресурсні колоди: COPE, цінності, ресурси, афірмації.",
      en: "MAC and resource decks: COPE, values, resources, affirmations.",
    },
    systemsHint: ["МАК", "Карти предків", "Карти емоцій", "Карти цінностей", "Карти ресурсів", "Афірмації", "Карти бажань"],
    articleMatch: ["мак", "cope", "коп", "эмоц", "емоц", "ценност", "цінност", "ресурс", "афірмац", "аффирм", "желан", "бажан", "предк", "роду"],
    hasSpreads: false,
  },
  {
    slug: "astrological",

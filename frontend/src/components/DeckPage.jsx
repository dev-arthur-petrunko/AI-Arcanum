...
export default function DeckPage({ deck, initialCards, relatedDeck, relatedCards }) {
  ...
  return (
    <>
      ...
      <main className="wrap" style={{ paddingTop: 110, paddingBottom: 60 }}>
        <DeckClientSuspense deck={deck} initialCards={initialCards} relatedDeck={relatedDeck} relatedCards={relatedCards} lang={lang} setLang={setLang} theme={theme} toggleTheme={toggleTheme} />
      </main>
    </>
  );
}
